...
export function validateIndianPhone(phone: string): ValidationError | null {
...
export function validateBarNumber(
  barNumber: string,
  state: string
): ValidationError | null {
...
export function validateMCA21RegistrationNumber(regNo: string): ValidationError | null {
...
export function validateGSTNumber(gst: string): ValidationError | null {
...
export function validateLawyerRegistration(
...
export function validateFirmRegistration(
  input: FirmRegistrationInput
): ValidationError[] {
  const errors: ValidationError[] = [];
